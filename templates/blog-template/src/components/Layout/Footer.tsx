...
const Footer = () => {
  ...
  return <footer className="bg-gray-800 text-gray-300" ref={ref} {...aiProps}>
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              A collection of articles across technology, travel, music, food, and more.
              Our goal is to share diverse perspectives and interesting stories.
            </p>
          </div>
        ...
        <div className="border-t border-gray-700 pt-6 text-sm text-center text-gray-400">
          <p>© {new Date().getFullYear()} Diverse Blog. All rights reserved.</p>
        </div>
      </div>
    </footer>;
};
